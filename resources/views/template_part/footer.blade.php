<div class="module-small bg-dark">
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <div class="widget">
                    <h5 class="widget-title font-alt">About John Nguyen</h5>
                    <p>I am John Nguyen. Real name is Nguyen Thanh Trung. I like it</p>
                    <p>Phone: +84 965 049 496</p>Fax: +1 234 567 89 10
                    <p>Email:<a href="#">trung.nguyenthanh.2702@gmail.com</a></p>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="widget">
...
<footer class="footer bg-dark">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <p class="copyright font-alt">&copy; 2019&nbsp;<a href="index.html">John Nguyen</a>, All Rights
                    Reserved</p>
            </div>
            <div class="col-sm-6">
